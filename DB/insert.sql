...
VALUES (1, 'Olympia', 100, 'Concert', '28 Boulevard des Capucines, Paris', 20, 30, 10, 5, 20),
    (2, 'Zénith', 150, 'Concert', '211 Avenue Jean Jaurès, Paris', 25, 35, 15, 7, 25),
    (3, 'Accor Arena', 200, 'Concert', '8 Boulevard de Bercy, Paris', 30, 40, 20, 10, 30),
    (4, 'Stade de France', 250, 'Concert', 'Saint-Denis, Paris', 35, 45, 25, 12, 35);
...
INSERT INTO CONCERT (idC, dateC, heureArrive, debutConcert, dureeConcert, dateMax, nombreTechNecessaire, besoinTransport, besoinHotel,idG, idS)
VALUES (1, '2025-03-01', '18:00:00', '19:00:00', '02:00:00', '2025-03-01',10, null,null, 1, 1),
    (2, '2025-03-02', '17:00:00', '18:00:00', '01:30:00', '2025-03-02',10, null,null, 2, 2),
    (3, '2025-03-03', '16:00:00', '17:00:00', '01:45:00', '2025-03-03',15, null,null, 3, 3),
    (4, '2025-03-04', '15:00:00', '16:00:00', '02:15:00', '2025-03-04',2, null,null, 4, 4);
