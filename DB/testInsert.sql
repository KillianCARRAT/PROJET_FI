...
INSERT INTO CONCERT (idC, dateC, heureArrive, debutConcert, dureeConcert,datemax idG, idS) 
...
INSERT INTO CONCERT VALUES(3,STR_TO_DATE("10/10/2014", "%d/%m/%Y"),'8:00:00','9:00:00',3,STR_TO_DATE("10/10/2014", "%d/%m/%Y"),1,1);
INSERT INTO CONCERT VALUES(4,STR_TO_DATE("10/10/2014", "%d/%m/%Y"),'10:00:00','11:00:00',3,STR_TO_DATE("10/10/2014", "%d/%m/%Y"),2,1);
INSERT INTO CONCERT VALUES(5,STR_TO_DATE("10/10/2014", "%d/%m/%Y"),'6:00:00','7:00:00',3,STR_TO_DATE("10/10/2014", "%d/%m/%Y"),2,1);
INSERT INTO CONCERT VALUES(6,STR_TO_DATE("10/10/2014", "%d/%m/%Y"),'5:00:00','6:00:00',3,STR_TO_DATE("10/10/2014", "%d/%m/%Y"),2,1);
...
INSERT INTO CONCERT VALUES(23,STR_TO_DATE("14/10/2015", "%d/%m/%Y"),'8:00:00','9:00:00',3,STR_TO_DATE("10/10/2014", "%d/%m/%Y"),2,4);

-- Insert de test pour pasDeCheuvauchementConcerts (contrainte 3)

INSERT INTO CONCERT VALUES(7,STR_TO_DATE("10/10/2010", "%d/%m/%Y"),'8:00:00','9:00:00',3,STR_TO_DATE("10/10/2014", "%d/%m/%Y"),1,1);
INSERT INTO CONCERT VALUES(8,STR_TO_DATE("10/10/2010", "%d/%m/%Y"),'13:00:00','14:00:00',3,STR_TO_DATE("10/10/2014", "%d/%m/%Y"),1,1);
INSERT INTO CONCERT VALUES(9,STR_TO_DATE("10/10/2010", "%d/%m/%Y"),'12:00:00','13:00:00',3,STR_TO_DATE("10/10/2014", "%d/%m/%Y"),1,1);
INSERT INTO CONCERT VALUES(10,STR_TO_DATE("10/10/2010", "%d/%m/%Y"),'9:00:00','10:00:00',3,STR_TO_DATE("10/10/2014", "%d/%m/%Y"),1,1);
INSERT INTO CONCERT VALUES(11,STR_TO_DATE("11/10/2010", "%d/%m/%Y"),'22:00:00','23:00:00',3,STR_TO_DATE("10/10/2014", "%d/%m/%Y"),1,1);
INSERT INTO CONCERT VALUES(12,STR_TO_DATE("12/10/2010", "%d/%m/%Y"),'01:00:00','2:00:00',3,STR_TO_DATE("10/10/2014", "%d/%m/%Y"),1,1);
INSERT INTO CONCERT VALUES(13,STR_TO_DATE("14/10/2010", "%d/%m/%Y"),'00:30:00','01:00:00',3,STR_TO_DATE("10/10/2014", "%d/%m/%Y"),1,1);
INSERT INTO CONCERT VALUES(14,STR_TO_DATE("13/10/2010", "%d/%m/%Y"),'23:00:00','23:30:00',3,STR_TO_DATE("10/10/2014", "%d/%m/%Y"),1,1);

-- Insert de test pour pasDeCheuvauchementPrepConcerts (contrainte 4)

INSERT INTO CONCERT VALUES(15,STR_TO_DATE("10/11/2010", "%d/%m/%Y"),'8:00:00','10:00:00',3,STR_TO_DATE("10/10/2014", "%d/%m/%Y"),1,1);
INSERT INTO CONCERT VALUES(16,STR_TO_DATE("10/11/2010", "%d/%m/%Y"),'13:00:00','15:00:00',3,STR_TO_DATE("10/10/2014", "%d/%m/%Y"),1,1);
INSERT INTO CONCERT VALUES(17,STR_TO_DATE("10/11/2010", "%d/%m/%Y"),'12:00:00','14:00:00',3,STR_TO_DATE("10/10/2014", "%d/%m/%Y"),1,1);
INSERT INTO CONCERT VALUES(18,STR_TO_DATE("10/11/2010", "%d/%m/%Y"),'9:00:00','11:00:00',3,STR_TO_DATE("10/10/2014", "%d/%m/%Y"),1,1);
